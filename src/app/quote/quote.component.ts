...
export class QuoteComponent implements OnInit {
  title = 'Wise Quotes';
  quotes: Quote[]=[
    new Quote(1,'Denis','Graditude',`If you look at what you have in life, you'll always have more. If you look at what you don't have you'll anever have enough.`,'Oprah Winfrey', new Date(2022,8,12),2,0),
    new Quote (2,'Wendy','Curiousity',`I have no special talents, I am only passionately curious.`,'Albert Einstein', new Date(2022,7,14),1,0),
